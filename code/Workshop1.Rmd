...
```{r}
data <- read_csv("Assignment 1-Default.Dataset")
```

# Step 2: Create a ggplot visualization
ggplot(data, aes(x = Year, y = MLD)) + 
  ...
  geom_ribbon(aes(ymin = Lower_CI, ymax = Upper_CI), 
              fill = "gray", alpha = 0.3) +  # Shaded confidence interval
  labs(title = "Improved Visualization of MLD Over Time",
       x = "Year",
       y = "MLD (m)") +
  theme_minimal() +  # Clean, professional look
  theme(
